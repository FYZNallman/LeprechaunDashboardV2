    ...
    <div class="vertical-menu"> 
        <simplebar class="h-100" ref="currentMenu" id="my-element"> 
            <div id="sidebar-menu"> 
                ...
                <div class="external-links"> <a href="https://x.com/LeprechaunBSC" target="_blank" class="external-link-button">  <img src="/images/twitter.png" alt="Twitter"/>  </a> <a href="https://bscscan.com/token/0xd445f4ccb4c73af58bba206bf255918e85c19b65" target="_blank" class="external-link-button">  <img src="/images/bscscan.png" alt="BSCScan"/>  </a> <a href="https://t.me/LeprechaunV2" target="_blank" class="external-link-button">  <img src="/images/telegram.png" alt="Telegram"/>  </a> 
                </div>                 
            </div>             
        </simplebar>         
    </div>     
